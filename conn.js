...
const gurbot = '6281236167286@s.whatsapp.net'
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 𝟒𝐊 𝐒𝐚𝐧𝐳𝐳`
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created by 4k sanzz' })
}
console.log(feta)
}
break
...
.then(data => {
var opt = { packname: '4K Sanzz', author: '𝐈𝐠 𝐟𝐡𝐥.𝐝𝐱𝟏𝟕' }
